<template>
    <div id="events">
        ...
        <div class="row py-2" id="projects">
            ...
            <a href="https://github.com/CodeForBaltimore/KnowYourRightsBaltimore" target="_blank"><img src="images/know-your-rights-1200x1100.jpg" class="img-fluid" alt="Know Your Rights Code for Baltimore project"></a>
            </div>
            ...
            <div class="col-lg-5 my-auto img-hov">
            <a href="https://github.com/CodeForBaltimore/JuryInstructions" target="_blank"><img src="images/jury-instructions-1200x100.jpg" class="img-fluid" alt="Jury Instructions Code for Baltimore project"></a>
            </div>
            <div class="col-lg-7 py-2 my-auto">
            ...
            <div class="col-lg-5 my-auto img-hov">
            <a href="https://github.com/syncthecity" target="_blank"><img src="images/sync-city-1200x1100.jpg" class="img-fluid" alt="Sync the City Code for Baltimore project"></a>
            </div>
            <div class="col-lg-7 py-2 my-auto">
            ...
            <button type="button" class="btn btn-outline-primary" href="">Load more</button>
            </div>
