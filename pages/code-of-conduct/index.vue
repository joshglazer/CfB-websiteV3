    ...
    <div id="code-of-conduct">
        ...
        <div class="row py-4" id="about-us">
            ...
            <h1 class="display-4">Code of Conduct Code</h1>
                ...
                <h3 class="my-3">Contact Brigade Organizers</h3>

                <p> Please contact Brigade organizers for any needs or concerns regarding Code of Conduct policies - <a href="mailto:hello@codeforbaltimore.org">hello@codeforbaltimore.org</a></p>
            </div>
        </div>
        </div>
    </div>
