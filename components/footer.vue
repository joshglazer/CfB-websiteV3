        ...
        <div class="row">
          <div class="col-sm">
            ...
            <ul>
              ...
              <li><a role="button" class="btn btn-outline-dark" target="_blank" href="https://github.com/CodeForBaltimore/codeforbaltimore.github.io/issues">Submit an issue</a></li>
            </ul>
          </div>
          <div class="col-sm">
            <h2>Connect</h2>
